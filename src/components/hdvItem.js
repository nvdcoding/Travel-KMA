          ...
          <div className="tour-guides-body">
            <ul className="tour-guides-list">
              ...
              <li className="tour-guides--item">
                ...
                <p className="tour-guides__text">Địa chỉ: Yên Phong</p>
              </li>
              <li className="tour-guides--item">
              ...
              <li className="tour-guides--item">
                ...
                <p className="tour-guides__text">Chuyến đi: 234 chuyến đi</p>
              </li>
            </ul>
            <Link
              to={`/trang-ca-nhan/${props.item.id}`}
              className="travel-link"
            >
              Chi tiết
            </Link>
          </div>
          <Link to={`/trang-ca-nhan/${props.item.id}`}>
