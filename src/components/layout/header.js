                ...
                <div className="pc">
                  ...
                  {Token ? (
                    <div className="header-user">
                      <img
                        src={user.avatar ? user.avatar : "https://media.istockphoto.com/id/1322277517/photo/wild-grass-in-the-mountains-at-sunset.jpg?s=612x612&w=0&k=20&c=6mItwwFFGqKNKEAzv0mv6TaxhLN3zSE43bWmFN--J5w="}
                        alt="avt"
                      />
