            ...
            <Layout>
                <div className="news__wrapper">
                    <div className="banner">
                        <img alt="" src="https://statics.vinpearl.com/dao-phu-quoc_1661246610.jpg" />
                    </div>
                            ...
                            <div className="news-list">
                                <div className="news-item">
                                    ...
                                    <div className="news-main">
                                        <h2 className="news-title"><Link to={`/tin-tuc/thflsnmx`}>[Tổng hợp] Các concept chụp ảnh nhóm lầy lội “bá đạo như hạt gạo”
                                        </Link></h2>
                                        <p className="news-des">Bạn muốn tìm những cách tạo dáng chụp ảnh nhóm lầy lội để giữ lại…
                                        </p>
                                        <div className="news-post-share-box">
                                            <div className="news-post-share-item">
                                                ...
                                                <a className="post-share-facebook" target="_blank" rel="noreferrer" href="#" title="Facebook">
