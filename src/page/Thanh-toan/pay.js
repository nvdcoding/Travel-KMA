                ...
                <div className="pay__wrapper">
                    <div className="method-payment-component">
                        ...
                        <div className="payment-online">
                            <div className="content">
                                <h3 className="payment-online__title">Chọn phương thức thanh toán</h3>
                                        ...
                                        <div className="order-payment">
                                            ...
                                            <div className="order-payment__btn">
                                                ...
                                                <a href="javascript:void(0)"
                                                    className="button button--normal">Quay
                                                    lại</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <ul className="hot-line">
                                    ...
                                    <li className="hot-line__item">
                                        ...
                                        <span className="hot-line__name">Miền Bắc: 0989 198 198</span>
                                    </li>
                                    <li className="hot-line__item">
                                        <span className="hot-line__icon">
                                            <img src="https://viettel.vn/images_content/payment-online-new/ic-contact.png" alt="img" />
                                        </span>
                                        <span className="hot-line__name">Miền Nam: 0989 198 198</span>
                                    </li>
                                    <li className="hot-line__item">
                                        <span className="hot-line__icon">
                                    ...
                                    <li className="hot-line__item">
                                        ...
                                        <span className="hot-line__name">Group giải đáp online</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
