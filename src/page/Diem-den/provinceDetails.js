                ...
                <div className="province-details__wrapper">
                    <div className="discover-detail">
                        <div className="discover-detail__menu">
                            <div className="content">
                                <ul className="discover-detail__menu-list">
                                    <li className="discover-detail__menu-item active">
                                        <a href="#" className="discover-detail__menu-link">
                                            <h5 className="discover-detail__menu-name">KHÁM PHÁ<br />TRẢI NGHIỆM</h5>
                                            <img src="https://vietteltelecom.vn/images_content/img-travel-menu-4.png"
                                                alt="icon KHÁM PHÁ TRẢI NGHIỆM" />
                                        </a>
                                    </li>
                                    <li className="discover-detail__menu-item">
                                        <a href="#" className="discover-detail__menu-link">
                        ...
                        <div className="discover-detail__info">
                            <div className="content">
                                <h3 className="discover-detail__info-title">
                                    Bà Nà Hills
                                </h3>
                                <div className="discover-detail__info-intro discover-detail__info-des">Ai đến Đà Nẵng lần đầu đều sẽ có mong
