...
<div className="travel-title-group">
<h3>Khoảng giá(đ)</h3>
<p className="travel-title-price"><input placeholder="Tối thiểu" /><span> - </span> <input placeholder="Tối đa" /></p>
</div>
</div>
</div>
</div>
